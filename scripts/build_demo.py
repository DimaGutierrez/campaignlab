...
html = html.replace('</head>', '<meta name="robots" content="noindex,follow"><link rel="canonical" href="https://diegogutierrez.pages.dev/campaignlab/"></head>')
html = html.replace('<footer>', '<footer><a href="/">← Portfolio</a> · ')
...
(out / "404.html").write_text('<!doctype html><html lang="es"><meta charset="utf-8"><title>CampaignLab · Página no encontrada</title><h1>Página no encontrada</h1><a href="/campaignlab/">Volver a la demo de CampaignLab</a></html>', encoding="utf-8")
